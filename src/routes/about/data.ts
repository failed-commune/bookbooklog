...
export const aboutData: AboutData[] = [
	{
		...
		description:
			'토스 디자인 시스템 및 머신러닝과 디자인을 접목하는 새로운 도구를 만드는 작업을 했습니다. 다양한 팀에 소속되어 제품 & 그래픽 디자이너, ML 사이언티스트 & 엔지니어, UX 리서처와 협업해 주도적으로 개발을 했습니다.',
		porjects: [
			{
				name: 'DEUS 팀',
				description:
					'데우스팀은 메이커(Designer, FE developer, Native developer)가 토스 디자인 시스템을 이용해 최대한의 효율을 낼 수 있게 돕는 디자인 에디터를 만들고 있습니다. 팀에서 디자인 시스템과 에디터 기능들을 개발하고 있습니다.',
				details: [
			...
			},
			{
				...
				description:
					'AI 그래픽 길드는 이미지 생성 ML 모델을 통해 제품에 필요한 이미지를 빠르게 만들 수 있는 제품을 만듭니다. 길드의 유일한 서비스 개발자로 주도적으로 개발을 했습니다. 머신러닝에 익숙하지 않은 디자이너들의 멘탈모델 형성을 돕는 UX를 만드는 것에 중점을 두고 개발했습니다.',
				details: [
			...
			},
			{
				...
				description:
					'토스의 NPS(Net Promoter Score)의 정량데이터 분석 대시보드를 만드는 작업을 했습니다. 엔드유저인 리서처의 사용성을 중점으로 시작해, 다양한 데이터 필터링과 시각화를 통해 인사이트를 얻을 수 있는 도구를 만드는 것을 목표로 잡고 빠르게 POC 했습니다.',
				details: ['NPS 정량 데이터(VOC) 대시보드 기획 및 POC 개발', '텍스트 전처리 방식 설계']
			},
			{
				name: 'AI UI Gen Guild',
				description:
					'토스 디자인 시스템(TDS)에 대한 개발적, 디자인적 이해를 기반으로 LLM(대규모 언어 모델) 학습 데이터와 방식을 기획하고 POC 했습니다.',
				details: ['LLM UI 디자인 생성 모델 기획 ', 'UI LLM을 위한 학습 데이터 생성']
			}
		]
	},
	{
		...
		porjects: [
			{
				...
				description:
					'React 기반으로 홈페이지 디자인 및 개발을 했습니다. 노션을 DB 겸 CMS로 사용해 관리 포인트를 최대한 줄일 수 있는 환경으로 기획하고 개발했습니다.',
				details: [
					'데이터리안 디자인 시스템 제작',
	...
	},
	{
		...
		porjects: [
			{
				name: '정성데이터(텍스트) 탐색 및 분석 도구 개발',
				description:
					'어피니티 다이어그램의 컨셉에서 출발해 UX리서처/데이터 분석가가 사용할 수 있는 도구를 개발했습니다.',
				details: [
			...
			},
			{
				...
				description:
					'유튜브, 트위터, 디스코드, 앱스토어 등 다양한 유저 보이스를 분석하기 위한 데이터 수집 도구를 개발했습니다.',
				details: [
